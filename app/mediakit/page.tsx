      ...
      <div className="flex flex-col gap-16 md:gap-24 z-20">
        ...
        >
          <div className="grid grid-cols-2 md:grid-cols-6 gap-3 md:gap-4">
            ...
            <div className="bg-tertiary  border border-primary col-span-1 md:col-span-2 p-6 flex flex-col justify-center md:items-center">
            ...
            <div className="md:hidden bg-tertiary  border border-primary col-span-1 md:col-span-2 p-6 flex flex-col justify-center md:items-center">
            ...
            <div className="bg-tertiary  border border-primary row-span-1 col-span-2 md:col-span-3 p-6 space-y-2">
            ...
            <div className="bg-tertiary  border border-primary row-span-2 col-span-2 md:col-span-3 pt-6 text-center overflow-clip order-last md:order-none">
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            ...
            >
              <Image
                className="bg-tertiary border border-primary w-full aspect-video "
